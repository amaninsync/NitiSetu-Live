...
import { Users, Building2 as Building, Tractor, Cloud, Users2, Factory } from 'lucide-react';
  ...
  return (
    <div className="container mx-auto space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <h1 className="text-2xl font-bold">District Stats</h1>
      ...
      {currentView === 'population' && (
        <div className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                <CardTitle>Female Distribution</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>Male Distribution</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                ...
                <div className="text-center mt-4">
                  ...
                  <div className="text-sm text-muted-foreground">Average Literacy Rate</div>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      {currentView !== 'population' && (
        <Card>
          <CardHeader>
            <CardTitle>{currentView.charAt(0).toUpperCase() + currentView.slice(1)} Statistics</CardTitle>
          </CardHeader>
          <CardContent className="flex items-center justify-center p-12">
            <p className="text-muted-foreground text-center">
              Data for {currentView} statistics will be available in the next phase.
            </p>
          </CardContent>
        </Card>
      )}
