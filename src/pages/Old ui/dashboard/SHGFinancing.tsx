...
const SHGFinancing = () => {
  return (
    <div className="container mx-auto p-4 space-y-6">
      <h1 className="text-3xl font-bold text-gov-blue">Project SHG Financing and Collection</h1>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="space-y-4">
          ...
          <Card className="p-4">
            <p className="text-sm text-gray-500">No. of Mandals</p>
        ...
        <div className="space-y-4">
          ...
          <Card className="p-4">
            <p className="text-sm text-gray-500">No. of Assoc Project Managers</p>
        ...
        <div className="space-y-4">
          ...
          <Card className="p-4">
            <p className="text-sm text-gray-500">No. of Community Coordinators</p>
      ...
      <Card className="p-6">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">74.9%</p>
          </div>
        </div>
              ...
              {data.map((row, i) => (
                <tr key={i} className="border-t">
                  ...
                  <td className="p-4 w-40">
                    ...
                    <p className="text-xs text-gray-500 mt-1">{row.achievementPercent}%</p>
                  </td>
                </tr>
              ))}
            </tbody>
