    ...
    theme: {
        ...
        extend: {
            fontFamily: {
                ...
                // Added 'heading' font family as per the reference styling
            ...
            colors: {
                ...
                // Added custom government-related colors from reference index.css
                'gov-blue': 'hsl(var(--gov-blue))',
                'gov-lightblue': 'hsl(var(--gov-lightblue))',
                'gov-darkblue': 'hsl(var(--gov-darkblue))',
            ...
            animation: {
                ...
                // Existing fade-in animation (kept as is based on user's input)
